...
export const About = () => {
    ...
    return(
        ...
        <div className='h-full bg-purple-900 md:flex sm:grid justify-between overflow- bl-4 p-10 py-6 sm:py-12'>
            
            <div className=' justify-center md:mt-16 md:ml-20 sm:ml-8 text-white pr-8'>
                <div className='mr-12'>
                <h1 className='font-black text-2xl '>Merakee Hive NFT collection Intro</h1>
                <p className='font-semibold text-base'>Merakee Hive NFT is an exclusive collection of 3,333 NFT <br /> masterpiece that enhanced the alpha boss spirit in you.   </p>
                </div>
            ...
            <div className='justify-center md:mr-14 '>
                <img className='h-550px w-550px mx-auto sm:mt-5' src={collage} />
            </div>
        </div>
    )
}