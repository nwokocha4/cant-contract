...
export const Details = () => {
    ...
    return(
        <div className='h-full p-10 bg-purple-900 md:flex sm:grid justify-between overflow-hidden py-6 sm:py-12'>
            <div className='justify-center md:ml-14 '>
                <img className='h-550px w-550px mx-auto' src={collage} />
            </div>
            <div className=' justify-center md:mt-10 md:ml-20 sm:ml-8 text-white pr-8'>
                <div className='mr-12 sm:mt-7'>
                <h1 className='font-black text-2xl '>Merakee Hive NFT: Mint Details</h1>
                </div>
